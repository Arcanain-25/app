document.addEventListener("DOMContentLoaded", function () {
    ...
    const mageImg = document.getElementById("mage-img");
    mageImg.addEventListener("click", (event) => {
    ...
    function createLevelRows(data2) {
    ...
    if (skillsData2) {
        document.getElementById('skills').innerHTML = createLevelRows(skillsData2);
    }

    // Заполнение таблицы талантов
    if (talentsData2) {
        document.getElementById('talents').innerHTML = createLevelRows(talentsData2);
    }
