document.addEventListener("DOMContentLoaded", function () {
    ...
    function createLevelRows(data4) {
    ...
    if (skillsData4) {
        document.getElementById('skills').innerHTML = createLevelRows(skillsData4);
    }

    // Заполнение таблицы талантов
    if (talentsData4) {
        document.getElementById('talents').innerHTML = createLevelRows(talentsData4);
    }
